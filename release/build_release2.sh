...
export GIT_COMMITTER_NAME="jc01rho"
export GIT_COMMITTER_EMAIL="rkjnice@gmail.com"
export GIT_AUTHOR_NAME="jc01rho"
export GIT_AUTHOR_EMAIL="rkjnice@gmail.com"
...
if [ ! -z "$CLEAN" ]; then
  ...
  # Create git repo
  git init
  git remote add origin git@github.com:jc01rho-openpilot-BoltEV2019-KoKr/openpilot.git
